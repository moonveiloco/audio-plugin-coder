...
## Esecuzione
Carica `agents/skills/impl/SKILL.md`
...
## CMake / JUCE
- JUCE è un submodule APC in `_tools/JUCE` (**JUCE 9.0.0**). **Non** usare `~/JUCE` o installazioni esterne.
...
- Da JUCE 8+ non esiste più `JuceHeader.h` auto-generato: i template chiamano `juce_generate_juce_header()` esplicitamente.
