...
**Reference:**
- `agents/troubleshooting/resolutions/webview-es6-modules-fail.md`
- `agents/skills/skill_design_webview/WEBVIEW-PRODUCTION-GUIDE.md`
...
**Reference:**
- `agents/troubleshooting/resolutions/webview-member-order-crash.md`
...
**Reference:**
- `agents/troubleshooting/resolutions/webview-juce8-api-changes.md`
...
**Reference:**
- `agents/troubleshooting/resolutions/webview-black-screen-resources.md`
...
### Skills
- **`agents/skills/skill_design_webview/SKILL.md`**
...
- **`agents/skills/skill_design_webview/KNOWN-ISSUES-AND-SOLUTIONS.md`** ⭐
  - This file
  - Quick reference for common issues

### Troubleshooting
- **`agents/troubleshooting/known-issues.yaml`**
  - Database of all known issues
  - Searchable by ID, category, symptoms

- **`agents/troubleshooting/resolutions/`**
...
2. **Then, search** `agents/troubleshooting/known-issues.yaml`
