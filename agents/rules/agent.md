...
- If the check **fails** (exit 1): APC is NOT configured. **STOP immediately.** Do NOT interpret the user's message as a plugin request. Do NOT suggest `/dream`, `/design`, `/plan`, or any other phase. Instead, execute the `/setup` skill (`agents/skills/setup/SKILL.md`) to guide the user through first-run configuration. Do NOT proceed with any other task until `setup_complete=true`.
...
*   **The Knowledge Base (`agents/troubleshooting/`):** Known issues and resolutions.
...
$issuesYaml = Get-Content agents/troubleshooting/known-issues.yaml -Raw
...
$existingIssues = (Get-Content agents/troubleshooting/known-issues.yaml | Select-String -Pattern "id: $category-" | Measure-Object).Count
...
Copy-Item agents/troubleshooting/_template.md agents/troubleshooting/resolutions\$newId.md

# Fill in basic info
$templateContent = Get-Content agents/troubleshooting/resolutions\$newId.md -Raw
...
See: agents/troubleshooting/resolutions\$newId.md
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
```powershell
# Update YAML status
$yamlContent = Get-Content agents/troubleshooting/known-issues.yaml -Raw
$yamlContent = $yamlContent -replace "id: $newId.*?resolution_status: investigating", "id: $newId`n    resolution_status: solved"
Set-Content -Path agents/troubleshooting/known-issues.yaml -Value $yamlContent
...
Full details: agents/troubleshooting/resolutions\$newId.md
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
1. **Always search first** - Check `agents/troubleshooting/known-issues.yaml` before trying random solutions
...
**ERROR HANDLING:**
If any command fails, **CHECK KNOWN ISSUES FIRST** before attempting random solutions. Search `agents/troubleshooting/known-issues.yaml` for matching error patterns. If found, apply documented solution. If not found and after 3 attempts, trigger auto-capture protocol.
