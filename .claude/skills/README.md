...
Catalogo delle skill disponibili in `.claude/skills/`. Ogni skill è una cartella
...
| [`test`](test/SKILL.md) | `/test [Name]` | Validazione (delega a `skill_testing`) |
...
| [`skill_testing`](skill_testing/SKILL.md) | Procedura di testing/validazione |
| [`skill_troubleshooting`](skill_troubleshooting/SKILL.md) | Risoluzione problemi nota-based (known-issues.yaml) |
...
1. Crea la cartella `.claude/skills/fix_<nome>/` con `SKILL.md`.
